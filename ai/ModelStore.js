...
export const DEFAULT_MODEL_DIRECTORIES = Object.freeze({
    ...
    'go/cylinder': 'models/go/cylinder/',
    'go/torus': 'models/go/torus/',
    'reversi/base': 'models/reversi/base/',
    'reversi/cylinder': 'models/reversi/cylinder/',
    'reversi/klein': 'models/reversi/klein/',
    'jump/base': 'models/jump/base/',
    'jump/polar': 'models/jump/polar/',
    'jump/triangular': 'models/jump/triangular/',
    'jump/cylinder': 'models/jump/cylinder/',
