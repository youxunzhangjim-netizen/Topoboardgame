const ZH = new Map(Object.entries({
  ...
  'Use 2D Cut View to check honeycomb torus and cylinder crossings: bracket rays follow only direct shared-edge hex cells.': '\u4f7f\u7528 2D \u5c55\u958b\u8996\u5716\u6aa2\u67e5\u8702\u5de2\u74b0\u9762\u8207\u5713\u67f1\u7a7f\u8d8a\uff1a\u593e\u64ca\u5c04\u7dda\u53ea\u6cbf\u8457\u76f4\u63a5\u5171\u908a\u7684\u516d\u908a\u5f62\u683c\u3002',
  ...
  'T2 honeycomb uses a zigzag nanotube-style hexagon net wrapped on a torus. Reversi stones occupy face centers; bracket rays follow only directly shared hex-cell edges. Use 2D Cut View to verify torus crossings.': 'T2 \u8702\u5de2\u4f7f\u7528\u92f8\u9f52\u5948\u7c73\u78b3\u7ba1\u5f0f\u516d\u908a\u5f62\u7db2\u683c\u5305\u6210\u74b0\u9762\u3002\u9ed1\u767d\u68cb\u68cb\u5b50\u4f4d\u65bc\u9762\u4e2d\u5fc3\uff1b\u593e\u64ca\u5c04\u7dda\u53ea\u6cbf\u8457\u76f4\u63a5\u5171\u908a\u7684\u516d\u908a\u5f62\u683c\u3002\u53ef\u7528 2D \u5c55\u958b\u8996\u5716\u6aa2\u67e5\u74b0\u9762\u7a7f\u8d8a\u3002',
  'Cylinder honeycomb wraps zigzag hexagon rings around the circumference, like a carbon nanotube. Reversi stones occupy face-cell centers; bracket rays follow only directly shared hex-cell edges. Use 2D Cut View to verify cylinder crossings.': '\u5713\u67f1\u8702\u5de2\u5c07\u92f8\u9f52\u516d\u908a\u5f62\u74b0\u7e5e\u5728\u5713\u5468\u4e0a\uff0c\u50cf\u5948\u7c73\u78b3\u7ba1\u3002\u9ed1\u767d\u68cb\u68cb\u5b50\u4f4d\u65bc\u9762\u683c\u4e2d\u5fc3\uff1b\u593e\u64ca\u5c04\u7dda\u53ea\u6cbf\u8457\u76f4\u63a5\u5171\u908a\u7684\u516d\u908a\u5f62\u683c\u3002\u53ef\u7528 2D \u5c55\u958b\u8996\u5716\u6aa2\u67e5\u5713\u67f1\u7a7f\u8d8a\u3002',
  ...
  'Research Builder': '研究建構器',
  'Open experiment construction and settings': '開啟實驗建構與設定',
  'Research Specification': '研究規格',
  'Research System & Method': '研究系統與方法',
  'Close Research System & Method': '收合研究系統與方法',
  'System under study': '研究系統',
  'Research objective': '研究目標',
  'Model definition': '模型定義',
  'Energy / Hamiltonian': '能量 / Hamiltonian',
  'Evolution protocol': '演化流程',
  'Ensemble / partition function': '系綜 / 配分函數',
  'Reported estimators': '報告估計量',
  'Numerical implementation': '數值實作',
  'Validity and scope': '有效性與適用範圍',
  'Research references': '研究參考資料',
  'Measured Output': '量測輸出',
  'Observable Definitions & Figures': '觀測量定義與圖表',
  'Figure observable': '圖表觀測量',
  "The figure updates from the selected model's recorded finite-step observations.": '圖表會依所選模型記錄的有限步驟觀測值更新。',
  'Definition': '定義',
  'Meaning': '意義',
  'Physics, mathematics, topology, graph dynamics, and information experiments with reproducible configuration, observables, comparison, and export.': '物理、數學、拓撲、圖動力學與資訊實驗，並提供可重現設定、觀測量、比較與匯出。',
  ...
  'Finite statistical cluster dynamics on a reusable topology graph.': '可重用拓撲圖上的有限統計團簇動力學。',
  ...
  'All z/w Slices': '全部 z/w 切片',
  '3D x/y/z slice': '3D x/y/z 切片',
  '4D stacked view': '4D 堆疊視圖',
  'Stacked View Controls': '堆疊視圖控制',
  'Legal Moves': '合法走法',
  'Visible w:': '可見 w：',
  ...
  'Black': '黑方',
  'White': '白方',
  'Final winning estimate': '終局勝率摘要',
  'Final win-rate flow': '終局勝率曲線',
  'Exact final result': '精確終局結果',
  'Win estimate': '勝率估計',
  'Game over.': '遊戲結束。',
  'Game drawn.': '平手。',
  'Chess result is exact; the percentage bars are a compact final-result view for local, robot, and online play.': '西洋棋結果已確定；百分比長條是本機、機器人與線上對局的精簡終局視圖。',
  'Chess result is exact; the bars show the completed local, robot, or online game result.': '西洋棋結果已確定；長條顯示本機、機器人或線上對局的完成結果。',
  'Reversi result is exact; the bars show the completed local, robot, or online game result.': '黑白棋結果已確定；長條顯示本機、機器人或線上對局的完成結果。',
  'Robot heuristic from saved board history; it is an evaluation curve, not a solved-game proof.': '這是機器人依已儲存局面歷史得到的啟發式評估曲線，不是已解遊戲證明。',
  'Robot heuristic replay from the move record; it is an evaluation curve, not a solved-game proof.': '這是機器人依走子紀錄回放得到的啟發式評估曲線，不是已解遊戲證明。',
  'Black to play': '黑方行動',
  'White to play': '白方行動',
  ...
  'L3 Search': 'L3 搜尋',
  'L4 Deep': 'L4 深搜',
  'Select Robot from Game Mode to use the robot as an opponent.': '在「遊戲模式」選擇機器人，即可讓機器人作為對手。',
  'Choose Robot in Game Mode to play against this local rule+search bot.': '在「遊戲模式」選擇機器人，即可與本機規則＋搜尋機器人對局。',
  'Select Robot from Game Mode for automatic robot play, or analyze the current position while playing locally.': '在「遊戲模式」選擇機器人可自動對局；本機對局時也可分析目前局面。',
  ...
  'Click Analyze Position to rank legal moves and show dynamic piece values.': '按「分析局面」可排列合法走法並顯示動態棋子價值。',
  'Click Analyze Position to rank Hex connection moves.': '按「分析局面」可排列六貫棋連線著法。',
  'Players': '玩家數',
  '2 players': '2 位玩家',
  '3 players': '3 位玩家',
  'Standard Jump': '標準跳棋',
...
let observer = null;
const GLOBE_ICON = '<svg aria-hidden="true" viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M3 12h18"></path><path d="M12 3a14 14 0 0 1 0 18"></path><path d="M12 3a14 14 0 0 0 0 18"></path></svg>';
...
function installStyles() {
  ...
  style.textContent = `.game-title-copy,.header>div:not(.game-title-actions),.top-bar>div:not(.game-title-actions),.jump-header>div:not(.game-title-actions){min-width:0}.game-title-copy h1,.game-title-copy p{overflow-wrap:anywhere}.game-title-actions{margin-left:auto;display:flex;align-items:center;justify-content:flex-end;gap:8px;flex:0 0 auto;position:relative;z-index:80}.header,.top-bar,.jump-header,.life-topbar{align-items:center}.header,.top-bar,.jump-header{display:flex;justify-content:space-between;gap:14px}.game-title-actions .language-icon-button,.language-switch.compact-language .language-icon-button,.shared-game-language-icon{width:30px!important;min-width:30px!important;height:30px!important;min-height:30px!important;padding:0!important;border:0!important;border-radius:999px!important;background:transparent!important;box-shadow:none!important;color:inherit!important;font-size:0!important;line-height:1;letter-spacing:0}.game-title-actions .language-icon-button svg,.language-switch.compact-language .language-icon-button svg,.shared-game-language-icon svg{width:17px!important;height:17px!important;fill:none!important;stroke:currentColor!important;stroke-width:1.35!important;stroke-linecap:round!important;stroke-linejoin:round!important}.shared-game-language,.language-switch.compact-language{position:relative!important;display:inline-flex!important;align-items:center!important;overflow:visible!important}.shared-game-language-icon{display:grid;place-items:center;cursor:pointer}.game-title-actions .language-icon-button:hover,.game-title-actions .language-icon-button:focus-visible,.language-switch.compact-language .language-icon-button:hover,.language-switch.compact-language .language-icon-button:focus-visible,.shared-game-language-icon:hover,.shared-game-language-icon:focus-visible{color:#ffe7ac;outline:none}.shared-game-language-menu,.game-title-actions .language-popover,.language-switch.compact-language .language-popover{position:absolute!important;right:0!important;top:calc(100% + 5px)!important;z-index:1200!important;align-items:center!important;grid-auto-flow:column!important;grid-template-columns:none!important;flex-direction:row!important;gap:6px!important;min-width:0!important;padding:8px 10px!important;border:0!important;border-radius:8px!important;background:rgba(15,20,27,.94)!important;box-shadow:0 18px 48px rgba(0,0,0,.38)!important;white-space:nowrap}.shared-game-language-menu{display:flex}.shared-game-language-menu[hidden]{display:none!important}.game-title-actions .language-popover,.language-switch.compact-language .language-popover{display:none!important}.game-title-actions .compact-language:hover .language-popover,.game-title-actions .compact-language:focus-within .language-popover,.game-title-actions .compact-language[data-language-open=true] .language-popover,.language-switch.compact-language:hover .language-popover,.language-switch.compact-language:focus-within .language-popover,.language-switch.compact-language[data-language-open=true] .language-popover{display:flex!important}.shared-game-language-menu button,.game-title-actions .language-popover button,.language-switch.compact-language .language-popover button{min-width:0!important;min-height:0!important;width:auto!important;padding:2px 4px!important;border:0!important;border-radius:0!important;background:transparent!important;color:inherit!important;font-size:13px!important;font-weight:900!important;line-height:1.2!important;cursor:pointer}.game-title-actions .language-popover button + button::before,.language-switch.compact-language .language-popover button + button::before{content:none!important}.shared-game-language-menu span,.game-title-actions .language-popover .shared-language-divider,.language-switch.compact-language .lang-divider{display:inline!important;font-size:13px!important;font-weight:900!important;color:inherit!important}.shared-game-language-menu button[aria-pressed=true],.game-title-actions .language-popover button[aria-pressed=true],.game-title-actions .language-popover button.active,.language-switch.compact-language .language-popover button.active{color:#ffe7ac!important;text-decoration:underline;text-underline-offset:4px}@media(max-width:620px){.header,.top-bar,.jump-header{align-items:flex-start}.header{position:relative;display:block;padding-top:50px}.header>.game-title-actions{position:absolute;right:0;top:0}.game-title-actions{gap:4px}.game-title-actions .space-home-link,.game-title-actions .jump-home-link,.game-title-actions .home-link{padding:7px 9px;min-height:32px}}`;
