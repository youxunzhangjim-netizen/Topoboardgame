...
const I18N = {
    en: {
        ...
        formalValidationText: 'Validation compares stored experiment hashes, replay state, event logs, and observable summaries before accepting a reproducibility claim.',
    ...
    zh: {
        ...
        formalValidationText: '\u9a57\u8b49\u5728\u63a5\u53d7\u53ef\u91cd\u73fe\u5ba3\u7a31\u524d\uff0c\u6bd4\u5c0d\u5132\u5b58\u7684\u5be6\u9a57\u96dc\u6e4a\u3001\u91cd\u64ad\u72c0\u614b\u3001\u4e8b\u4ef6\u7d00\u9304\u8207\u89c0\u6e2c\u91cf\u6458\u8981\u3002',
        loadSample: '載入範例',
        quickReplay: '檢查重播',
        runAll: '執行驗證套件',
        loadedType: '載入類型',
