...
export class Flat4DGoGame {
    ...
    computeAreaScore() {
        const score = {
            ...
            komi: this.komi,
            scoring: 'graph-area',
            territoryRule: 'Empty regions are counted as territory only when every bordering stone on the selected 4D board graph belongs to one player; otherwise the region is neutral.'
        };
